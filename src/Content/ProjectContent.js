const Project = [
...

  {
    ...
    gif: "",
    description:
      "Built an android app that allows users to view movies from the The Movie Database API.",
    features: [
      "Users can view a list of movies.",
      "Users can see a movie's details by clicking on it.",
...

  {
    ...
    features: [
      "Users can sign up and log in to their account and og out from their account.",
